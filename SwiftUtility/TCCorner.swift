...
extension UIView {
    func tc_addCorner(radius radius: CGFloat) {
        self.tc_addCorner(radius: radius, borderWidth: 1, backgroundColor: UIColor.clearColor(), borderColor: UIColor.blackColor())
    }
    ...
    func tc_addCorner(radius radius: CGFloat,
        ...
        borderColor: UIColor) {
            let imageView = UIImageView(image: tc_drawRectWithRoundedCorner(radius: radius,
    ...
    func tc_drawRectWithRoundedCorner(radius radius: CGFloat,
        borderWidth: CGFloat,
        backgroundColor: UIColor,
...
extension UIImageView {
    /**
     ...
     :param: radius 圆角半径
     */
    override func tc_addCorner(radius radius: CGFloat) {
        self.image = self.image?.tc_drawRectWithRoundedCorner(radius: radius, self.bounds.size)
    }
}

extension UIImage {
    func tc_drawRectWithRoundedCorner(radius radius: CGFloat, _ sizetoFit: CGSize) -> UIImage {
